        ...
        <div style="clear: both; margin-left: 1%">
            ...
            <div id="pagination_controls">
                ...
                <form action="" method="post" class="pagination_btns">
    ...
    <div class="tWrap__body" id="orderDiv">
      <table id="orderTracker" class="merchant_tbl">
        <tbody>
        <?php foreach ($orderResult as $orderRow){?>
                     ...
                     <tr <?php
                         ...
                         ?> style="height: 35px; background-color: <?php if (intval($orderRow['CashAmt']) != round($orderRow['packagePrice']) and $orderRow['Cash'] == 'Y'){echo "yellow";} if ($orderRow['orderType'] == 'smartPick'){echo "#d6c7c2";}?>; <?php if ($diffDist ==1){?>  border-top: 2px solid #3e3a75; border-left: 2px solid #3e3a75; border-right: 2px solid #3e3a75; border-bottom: 2px solid #3e3a75; <?php }?> font: 11px 'paperfly roman'">
                        <td style="border-right: 1px dotted #afa7a7">
                        ...
                        <td style="border-right: 1px dotted #afa7a7">
                            <?php if ($orderRow['pickPointEmp'] !='' and $orderRow['Pick'] == '') {?>
                                <button id="pick<?php echo $orderRow['orderid'];?>" style="background-color: #dbd9d9; height: 26px; width: 26px; border-radius: 50px; border: 1px solid #5a5959" onclick="<?php if ($orderRow['orderType'] == 'smartPick'){ echo "return SmartPickUpdate('".$orderRow['orderid']."')"; } else { echo "return PickUpdate('".$orderRow['orderid']."')";}?>"></button>
                            <?php } else {?>
                                <?php if ($orderRow['Pick'] !='') {?>
                                    <?php if($orderRow['orderType'] == 'smartPick'){?>
                                        ...
                                        <button id="pick<?php echo $orderRow['orderid'];?>" style="background-color: green; height: 26px; width: 26px; border-radius: 50px; border: 1px solid green" onclick="<?php echo "return smartPickMsg('".$orderRow['orderid']."')"?>" ></button>
                                    <?php } else {?>
                                        <button id="pick<?php echo $orderRow['orderid'];?>" style="background-color: green; height: 26px; width: 26px; border-radius: 50px; border: 1px solid green" disabled ></button>
                                    <?php }?>
                                <?php }else {?>
                                    <button id="pick<?php echo $orderRow['orderid'];?>" style="background-color: #dbd9d9; height: 26px; width: 26px; border-radius: 50px; border: 1px solid #5a5959" disabled></button>
                                <?php }?>
                            <?php }?>
                        </td>
                        <td style="border-right: 1px dotted #afa7a7">
                            <?php if ($orderRow['Pick'] =='Y' and $orderRow['DP1'] !='Y') {?>
                                <button id="dp1<?php echo $orderRow['orderid'];?>" style="background-color: #dbd9d9; height: 26px; width: 26px; border-radius: 50px; border: 1px solid #5a5959" onclick="<?php echo "return DP1Update('".$orderRow['orderid']."')"?>"></button>
                            <?php }else{?>
                                <?php if($orderRow['DP1'] =='Y'){?>
                                    <button id="dp1<?php echo $orderRow['orderid'];?>" style="background-color: green; height: 26px; width: 26px; border-radius: 50px; border: 1px solid green" disabled></button>
                                <?php }else{?>
                                    <button id="dp1<?php echo $orderRow['orderid'];?>" style="background-color: #dbd9d9; height: 26px; width: 26px; border-radius: 50px; border: 1px solid #5a5959" disabled></button>
                                <?php }?>
                            <?php }?>
                        </td>
                        <td style="border-right: 1px dotted #afa7a7;">
                            <?php if($orderRow['Shtl'] =='Y' and $orderRow['DP2'] !='Y'){?>
                                <button id="DP2<?php echo $orderRow['orderid'];?>" style="background-color: #dbd9d9; height: 26px; width: 26px; border-radius: 50px; border: 1px solid #5a5959" onclick="<?php echo "return DP2Update('".$orderRow['orderid']."')"?>"></button>
                            <?php }else{?>
                                <?php if($orderRow['DP2'] =='Y'){?>
                                    <button id="DP2<?php echo $orderRow['orderid'];?>" style="background-color: green; height: 26px; width: 26px; border-radius: 50px; border: 1px solid green" disabled></button>
                                <?php }else{?>
                                    <button id="DP2<?php echo $orderRow['orderid'];?>" style="background-color: #dbd9d9; height: 26px; width: 26px; border-radius: 50px; border: 1px solid #5a5959" disabled></button>
                                <?php }?>
                            <?php }?>
                        </td>
                        <td style="border-right: 1px dotted #afa7a7;    border-bottom: 1px dotted #afa7a7; background-color: #ececec;">
                            ...
                            <?php if($orderRow['PickDrop'] =='Y' and $orderRow['Cash'] !='Y' and $orderRow['Ret'] !='Y' and $orderRow['partial'] !='Y'){?>
                                <button id="Cash<?php echo $orderRow['orderid'];?>" style="background-color: #dbd9d9; height: 26px; width: 26px; border-radius: 50px; border: 1px solid #5a5959" onclick="<?php echo "return CashUpdate('".$orderRow['orderid']."')"?>"></button>
                            <?php }else{?>
                                <?php if($orderRow['Cash'] =='Y'){?>
                                    <button id="Cash<?php echo $orderRow['orderid'];?>" style="background-color: green; height: 26px; width: 26px; border-radius: 50px; border: 1px solid green" onclick="<?php echo "return cashmsg('".$orderRow['orderid']."')"?>"></button>
                                <?php }else{?>
                                    <button id="Cash<?php echo $orderRow['orderid'];?>" style="background-color: #dbd9d9; height: 26px; width: 26px; border-radius: 50px; border: 1px solid #5a5959" disabled></button>
                                <?php }?>
                            <?php }?>
                        </td>
                        <td style="border-right: 1px dotted #afa7a7;     border-bottom: 1px dotted #afa7a7;background-color: #ececec;">
                            ...
                            <?php if($orderRow['PickDrop'] =='Y' and $orderRow['Cash'] !='Y' and $orderRow['Ret'] !='Y' and $orderRow['partial'] !='Y'){?>
                                <button id="Ret<?php echo $orderRow['orderid'];?>" style="background-color: #dbd9d9; height: 26px; width: 26px; border-radius: 50px; border: 1px solid #5a5959"></button>
                            <?php }else{?>
                                <?php if($orderRow['Ret'] =='Y'){?>
                                    <button id="Ret<?php echo $orderRow['orderid'];?>" style="background-color: red; height: 26px; width: 26px; border-radius: 50px; border: 1px solid red" onclick="<?php echo "return showRetmsg('".$orderRow['orderid']."')"?>"></button>
                                <?php }else{?>
                                    <button id="Ret<?php echo $orderRow['orderid'];?>" style="background-color: #dbd9d9; height: 26px; width: 26px; border-radius: 50px; border: 1px solid #5a5959" disabled></button>
                                <?php }?>
                            <?php }?>
                        </td>
                        <td style="border-right: 1px dotted #afa7a7;     border-bottom: 1px dotted #afa7a7; background-color: #ececec; ">
                            ...
                            <?php if($orderRow['PickDrop'] =='Y' and $orderRow['Cash'] !='Y' and $orderRow['Ret'] !='Y' and $orderRow['partial'] !='Y'){?>
                                <button id="partial<?php echo $orderRow['orderid'];?>" style="background-color: #dbd9d9; height: 26px; width: 26px; border-radius: 50px; border: 1px solid #5a5959" onclick="<?php echo "return partialUpdate('".$orderRow['orderid']."')"?>"></button>
                            <?php }else{?>
                                ...
                                <?php }else{?>
                                    <button id="partial<?php echo $orderRow['orderid'];?>" style="background-color: #dbd9d9; height: 26px; width: 26px; border-radius: 50px; border: 1px solid #5a5959" disabled></button>
                                <?php }?>
                            <?php }?>
                        </td>
                        <td style="border-right: 1px dotted #afa7a7;    border-bottom: 1px dotted #afa7a7; background-color: #ececec;">
                            ...
                            <?php if($orderRow['PickDrop'] =='Y' and $orderRow['Cash'] !='Y' and $orderRow['Ret'] !='Y' and $orderRow['partial'] !='Y' and $orderRow['Rea'] !='Y'){?>
                                <button id="Rea<?php echo $orderRow['orderid'];?>" style="background-color: #dbd9d9; height: 26px; width: 26px; border-radius: 50px; border: 1px solid #5a5959" onclick="<?php echo "return holdUpdate('".$orderRow['orderid']."')"?>"></button>
                            <?php }else{?>
                                <?php if($orderRow['Rea'] =='Y'){
                                    if ($orderRow['Cash'] !='Y' and $orderRow['Ret'] !='Y' and $orderRow['partial'] !='Y'){
                                ?>
                                        <button id="Rea<?php echo $orderRow['orderid'];?>" style="background-color: yellow; height: 26px; width: 26px; border-radius: 50px; border: 1px solid #a5a501" onclick="<?php echo "return holdUpdate('".$orderRow['orderid']."')"?>"><?php echo substr($orderRow['onHoldSchedule'], 8, 2);?></button>
                                    <?php } else {?>
                                        <button id="Rea<?php echo $orderRow['orderid'];?>" style="background-color: yellow; height: 26px; width: 26px; border-radius: 50px; border: 1px solid #a5a501" disabled><?php echo substr($orderRow['onHoldSchedule'], 8, 2);?></button>
                                <?php }}else{?>
                                    <button id="Rea<?php echo $orderRow['orderid'];?>" style="background-color: #dbd9d9; height: 26px; width: 26px; border-radius: 50px; border: 1px solid #5a5959" disabled></button>
                            <?php }?>
                            <?php }?>
                        </td>
                        <td>
                            <?php if($orderRow['DropDP2'] =='Y' and $orderRow['close'] !='Y'){?>
                                <button id="close<?php echo $orderRow['orderid'];?>" style="background-color: #dbd9d9; height: 26px; width: 26px; border-radius: 50px; border: 1px solid #5a5959" onclick="<?php echo "return CloseUpdate('".$orderRow['orderid']."')"?>"></button>
                            <?php }else{?>
                                <?php if($orderRow['close'] =='Y'){?>
                                    <button id="close<?php echo $orderRow['orderid'];?>" style="background-color: green; height: 26px; width: 26px; border-radius: 50px; border: 1px solid green" disabled></button>
                                <?php }else{?>
                                    <button id="close<?php echo $orderRow['orderid'];?>" style="background-color: #dbd9d9; height: 26px; width: 26px; border-radius: 50px; border: 1px solid #5a5959" disabled></button>
                                <?php }?>
                            <?php }?>
                        </td>
                    </tr>
                ...
                <div class="modal-body" style="text-align: center">
                    ...
                    <button id="btnCancel" class="btn btn-default">Cancel</button>
                                    ...
                                    <div class="footer-note">
                                               <footer> &nbsp;For any enquiry call us at: 01998-706032 &nbsp; </footer>
                                     </div>
