        ...
        if ($flag == 'assignDrop'){
            ...
            if (!mysqli_query($conn,$updatesql)){
                ...
                if($dropPointCode == 'A1'|| $dropPointCode == 'A2' || $dropPointCode == 'A3' || $dropPointCode == 'A4'|| $dropPointCode == 'A5'|| $dropPointCode == 'A6'){
                    ...
                    $message = "Dear Customer, we also provide bKash account opening service - FREE! Please keep your NID copy and 2 passport size photos ready if interested. Paperfly.";
