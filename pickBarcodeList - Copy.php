    ...
    {    
        ...
        if (isset($_GET['merchant'])){
            ...
            foreach ($pickOrderListResult as $pickOrderListRow){
                ...
                $pdf->SetXY(0, 21);
                $pdf ->MultiCell(78,4,$pickOrderListRow['merOrderRef'], '', 'C', 0);
                ...
                $pdf->SetXY(3, 32);
                $pdf ->MultiCell(74,3,'Customer Address : '.$pickOrderListRow['custaddress'], '', 'L', 0);
                $pdf->SetXY(3, 43);
                $pdf ->MultiCell(78,3,'Package price    : '.$pickOrderListRow['packagePrice'], '', 'L', 0);
                $pdf->SetXY(3, 46);
                $pdf ->MultiCell(74,3,'Package breif    : '.$pickOrderListRow['productBrief'], '', 'L', 0);
                $pdf->SetXY(3, 55);
                ...
                $pdf->SetXY(3, 69);
                $pdf ->MultiCell(60,4,$pickOrderListRow['dropPointCode'], '', 'R', 0);
