...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row merchant_header">
                <div class="col-sm-6 ">
                    <br>
                    <a class="welcome_tag" href="#">Welcome <u><?php echo $uName ; ?></u></a>
                </div>
                <div class="col-sm-6 merchant_header_logo">
                    <img style="height: 25%; width: 25%; float: right" src="image/wingslogo.png" />
                </div>
            </div>
            <div class="row">
            <nav style ="width: 100%; float: left" role="navigation" class="navbar navbar-default navbar-custom merchant_menu">
                <div class="col-sm-8">
                       ...
                       <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navigationbar">
                        ...
                        <div style="color: #00AEEF" class="collapse navbar-collapse" id="navigationbar">
                            <ul class="nav navbar-nav">
                                <li>
                                    <a  href="Merchant-Dashboard">Home</a>
                                </li>
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <?php } if ($menuRow['measureOrders'] == 'Y') {?>
                                        <li>
                                            <a href="Measure-Product">Measure Product</a>
                                        </li>
                                        <?php }?>      
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="dropdown-submenu">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li class="dropdown">
                                                    <a tabindex="1" href="Unregisterd-Merchant">Merchant Application</a>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        <?php }if ($menuRow['facilityInfo'] == 'Y') {?>
                                        <li>
                                            <a href="Facility-Info">Facility Info</a>
                                        </li>
                                        <?php }?>
                                    </ul>
                                </li>
                                ...
                                <li class = "dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a href="M-Invoice-Print-Search">Print Invoices</a>
                                        </li>
...
<?php
        ...
        header("location: paperfly_login.php");
    }
?>
