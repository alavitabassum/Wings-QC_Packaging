...
";
            ...
            if($flag == 'acceptOrder'){
                ...
                if(empty($empCode)){
                    ...
                    $updateSQL = "update tbl_order_details set barcode = '$orderid', pickPointEmp = '$empCode', Pick = 'Y', PickTime = NOW() + INTERVAL 6 HOUR, PickBy = '$pickedBy' where orderid = '$paperflyID' and Pick is null";
