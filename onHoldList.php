<?php
    ...
    if(isset($_POST['username'])){
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $merchantPickSQL = "SELECT orderid, barcode, merchantCode, merOrderRef, packagePrice, custname, custphone, onHoldSchedule, onHoldReason as phone  FROM tbl_order_details  WHERE PickDrop is null and dropPointEmp = '$userCode'"; 
